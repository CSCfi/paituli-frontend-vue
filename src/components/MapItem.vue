...
const { datasets, currentDataset, fetchDatasets, isFetching, setCurrent } = useDatasets()
const { indexLayerSource, osmSource, dataLayerSource, dataLayerMaxResolution } = useSources()
...
<template>
  ...
  <div class="map">
    <LocationSearchField />
    <Map.OlMap style="min-width: 1000px; height: 600px">
      ...
      <Interactions.OlInteractionSelect
        ...
        :multi="true"
      />
      <Interactions.OlInteractionDragbox @boxend="dragboxEnd" :condition="shiftKeyOnly" />
