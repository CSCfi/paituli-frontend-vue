<template>
  ...
  <p>
    ...
    is a specification to describe geospatial datasets with temporal dimension.
    It drastically simplifies <strong>searching and downloading</strong>
    datasets. STAC includes only the metadata of datasets and links to the
    actual files. The data files themselves are usually stored in the cloud.
    STAC is most often used for remote sensing imagery and other
    raster data, but it can be used also for vector and point cloud data.
    STAC is especially suitable for time-series applications.
  </p>
  ...
  <c-list>
    <c-list-item>
      ...
      <ul>
        <li>
          Paituli own data, only raster data, a lot of different datasets.
          Files in different formats, inc. GeoTiff, COG, JPG2000 and NetCDF format.
        </li>
        <li>
  ...
  <p>
    If you have any feedback, please contact CSC, servicedesk@csc.fi.
    If you would be interested that some (your?) data is added to Paituli STAC,
    first make sure it is available via URL-links (in cloud-optimized format)
    and then contact CSC.
  </p>
</template>
