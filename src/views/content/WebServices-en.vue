...
<template>
  ...
  <p>
    In WMTS services maps are available only in pre-defined
    scales and sizes. In WMS services scale and map size can be
    set without restrictions. WMTS services are faster,
    because often the map tiles are already cached at the server.
    For requesting only part of data different filters may
  ...
  <ul>
    <li><a href="https://docs.qgis.org/latest/en/docs/user_manual/working_with_ogc/ogc_client_support.html#">QGIS manual: Working with OGC / ISO protocols</a></li>
    <li><a href="https://pro.arcgis.com/en/pro-app/latest/help/data/services/ogc-services.htm">ArcGIS Pro user manual: About using OGC service layers</a></li>
    <li><a href="https://pro.arcgis.com/en/pro-app/latest/help/data/services/add-ogc-api-services.htm">ArcGIS Pro user manual: Add OGC API services</a></li>
