...
modules/
  ...
  helpText.ts   Help sidebar visibility and content
...
Currently only hosts toasts.ts for user alerts.

### src/directives
Custom attributes you can add to elements.
